...
namespace ULDiario.Data.Repositories
{
    public class QuinaRepository 
    {
        ...
        public QuinaRepository(IConfiguration configuration)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<Jogo> RecuperarUltimoResultadoQuina()
        {
            using (MySqlConnection connection = new MySqlConnection(_connectionString))
            {
                var Quina = await connection.QueryFirstOrDefaultAsync<Quina>(
                @"
                    SELECT DISTINCT
	                     ...
	                     RS.QTD_GANHADORES_DUQUE_1 as QtdeGanhadoresDuque1,
	                     RS.VALOR_GANHADORES_DUQUE_1 as ValorGanhadoresDuque1, 
	                     ...
	                     RS.QTD_GANHADORES_DUQUE_2 as QtdeGanhadoresDuque2,
	                     RS.VALOR_GANHADORES_DUQUE_2 as ValorGanhadoresDuque2, 
        ...
        public async Task<bool> SalvarResultadoQuina(List<Jogo> lista)
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(_connectionString))
                {
                    ...
                    var duque1 = ultimoConcurso.premiacao.Where(s => s.acertos.Equals(2)).Select(s => s).FirstOrDefault();
                    ...
                    var duque2 = ultimoConcurso.premiacao.Where(s => s.acertos.Equals(2)).Select(s => s).FirstOrDefault();
                    ...
                    var resultId = await connection.ExecuteAsync(sql, new
                    {
                        ...
                        QTD_GANHADORES_DUQUE_1 = duque1.quantidade_ganhadores,
                        VALOR_GANHADORES_DUQUE_1 = duque1.valor_total,
                        ...
                        QTD_GANHADORES_DUQUE_2 = duque2.quantidade_ganhadores,
                        VALOR_GANHADORES_DUQUE_2 = duque2.valor_total,
